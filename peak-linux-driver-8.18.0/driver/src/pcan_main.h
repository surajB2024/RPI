...
/* redefine libc felx array to be strictly compatible with ubsan */
#undef pcanfd_available_clocks
...
/* clocks value list base type (flexible item list) */
...
#ifdef CONFIG_UBSAN_BOUNDS_STRICT
	struct pcandev *devs[];		/* a device for each CAN controller */
#else
